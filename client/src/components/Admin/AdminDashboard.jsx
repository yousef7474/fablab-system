...
const AdminDashboard = () => {
  ...
  // or null when the modal is closed. Replaces the earlier
  // window.prompt fallback with a proper in-app dialog.
...
<body>
  ...
  // Extend a workspace's period through a proper in-app modal — was
  // previously done via a browser `prompt` which felt hacky. Opens
  // the dialog pre-filled with (current end + 24h) so the common
  // "one more day" case is one click away.
  ...
  const menuItems = [
    ...
    { id: 'project-support', icon: 'project-support', labelEn: 'Project Support', labelAr: 'طلبات دعم المشاريع' },
  ...
  const getIcon = (iconName) => {
    const icons = {
      ...
      'project-support': <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 12a4 4 0 0 1 4-4h1l3-3 3 3h1a4 4 0 0 1 4 4v2H4z"/><path d="M4 14h16v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/><path d="M12 3v5"/></svg>,
    ...
    <div className="admin-layout" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <main className="admin-main">
        ...
        <div className="admin-content">
              ...
              >
                ...
                <div className="sv2-grid">
                  ...
                  <div className="sv2-right">
                    ...
                    {/* Task creation moved off the admin schedule — each
                        employee now adds & updates their own tasks from
                        the employee dashboard. Manager-assigned tasks
                        still flow through the Manager schedule tab. */}
                    ...
                    workspaces.map(workspace => (
                      ...
                      >
                        ...
                        <div className="workspace-actions">
                          ...
                          {/* Extend button — active AND completed. Completed
                              workspaces get auto-marked when their end period
                              passes; this button re-opens them for the same
                              person without recreating the row. */}
            ...
            {/* Extend workspace period modal — proper in-app dialog
                with real date+time pickers. Replaces the earlier
